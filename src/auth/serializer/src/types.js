...
Types.asset = {
    fromByteBuffer(b){
        ...
        else
        {
            ...
            b.skip(7)
            // "1.000 PIXA" always written with full precision
            amount_string = fromImpliedDecimal(amount, precision)
        }
    ...
    toObject(object, debug = {}){
        if (debug.use_default && object === undefined) { return "0.000 PIXA"; }
        return object
    }
}
...
Types.asset_symbol = {
    fromByteBuffer(b){
        ...
        else
        {
          ...
          if(symbol == "PXC" || symbol == "PXCT")
            nai_string = "@@000000021"
          else if(symbol == "PXS" || symbol == "PXST")
            nai_string = "@@000000013"
          else if(symbol == "PXP" || symbol == "PXPT")
